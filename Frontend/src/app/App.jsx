...
import ProfilePage from '../domains/users/pages/ProfilePage';
import BecomeWorkerPage from '../domains/professions/pages/BecomeWorkerPage';
import SearchPage from '../domains/professions/pages/SearchPage';
import WorkerProfilePage from '../domains/users/pages/WorkerProfilePage';
import TermsPage from '../domains/legal/pages/TermsPage';
