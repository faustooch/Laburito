...
function WorkerCard({ worker }) {
  ...
  return (
    <div 
      ...
      className="relative overflow-hidden bg-neutral-900/40 border border-neutral-800/50 rounded-3xl p-6 transition-all duration-300 hover:-translate-y-1 hover:border-neutral-700/80 hover:bg-neutral-900/60 hover:shadow-2xl hover:shadow-slate-500/5 flex flex-col h-full group"
    >
        ...
        <div className="relative shrink-0">
          {worker.profile_picture_url ? (
            <img 
              ...
              alt={worker.nickname} 
              className="w-16 h-16 rounded-full object-cover border-2 border-neutral-800 group-hover:border-slate-500/50 transition-colors duration-300 shadow-sm"
            />
          ) : (
            <div className="w-16 h-16 rounded-full bg-neutral-800 border-2 border-neutral-700 flex items-center justify-center text-2xl font-black text-slate-500 uppercase transition-colors duration-300 group-hover:border-slate-500/50 shadow-sm">
