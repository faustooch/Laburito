...
function SearchPage() {
  ...
  // Efecto de montaje inicial para la animación
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col overflow-x-hidden">
      ...
      {/* 1. Al main le agregamos flex flex-col */}
      <main className="flex-grow w-full max-w-7xl mx-auto px-6 py-12 flex flex-col">
        
        {/* 2. El div animado ahora es flex-grow y flex-col */}
        <div 
          className={`flex-grow flex flex-col transform transition-all duration-1000 ease-out ${
            isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
          }`}
        >
          {/* Cabecera y Barra de Filtros (con shrink-0 para que no se aplaste) */}
          <div className="mb-8 flex flex-col lg:flex-row lg:items-end justify-between gap-8 border-b border-neutral-800/50 pb-8 shrink-0">
            ...
            <div className="flex-grow">
              ...
              <h1 className="text-4xl md:text-5xl font-black text-neutral-50 tracking-tight leading-tight">
                {query || profession ? (
                  <>
                    "{query || profession}"
                  </>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              {(city || minRating > 0 || profession) && (
                <button 
                  ...
                  className="ml-2 flex items-center justify-center p-3 text-neutral-500 bg-neutral-900/30 border border-neutral-800 hover:text-red-400 hover:bg-red-500/10 hover:border-red-500/30 rounded-2xl transition-all cursor-pointer"
          ...
          {/* 3. El contenedor principal de los resultados también es flex-grow */}
          <div className="w-full flex-grow flex flex-col">
            {isLoading ? (
              ...
              <div className="flex-grow flex flex-col items-center justify-center text-center px-4 bg-neutral-900/20 border border-dashed border-neutral-800/80 rounded-3xl mt-2 min-h-[400px]">
                ...
                {/* Botón rápido para limpiar filtros dentro del Empty State */}
                {(city || minRating > 0 || profession) && (
                  <button 
                    onClick={() => setSearchParams(query ? { q: query } : {})}
