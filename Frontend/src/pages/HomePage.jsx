...
// Eliminamos el import de WelcomeBanner
...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col overflow-x-hidden">
      ...
      {user ? (
        ...
        // pt-32 empuja el contenido por debajo del header flotante. 
        // space-y-24 genera un respiro enorme (96px) entre el slider y los destacados.
        <main className="flex-grow w-full max-w-7xl mx-auto px-4 pb-20 pt-32 flex flex-col space-y-24">
          
          {/* Aplicamos py-4 y -my-4 para generar un área de desbordamiento segura (bleed area) 
              que evita que las tarjetas se decapiten al hacer hover */}
          ...
          {/* Aplicado también a los trabajadores destacados por si implementaste la misma física */}
  ...
  {/* Badge Superior */}
  <div className={`mb-6 inline-block px-3 py-1 rounded-full border border-orange-500/20 bg-orange-500/5 text-orange-500 text-xs font-bold uppercase tracking-widest transform transition-all duration-700 ease-out ${isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-6'}`}>
  ...
  <p className={`text-lg md:text-xl text-neutral-400 mb-12 font-medium max-w-xl mx-auto leading-relaxed transform transition-all duration-700 delay-300 ease-out ${isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
    ...
    <span className="text-neutral-600 text-base font-normal">Soluciones reales a un clic de distancia.</span>
  </p>

  {/* Botón Original con Hover sutil */}
  <button 
    onClick={() => navigate('/register')} 
    className={`bg-orange-500 text-white font-bold text-lg px-8 py-4 rounded-full 
               transition-all duration-300 hover:bg-orange-600 hover:scale-105 active:scale-95 
               shadow-[0_0_20px_rgba(249,115,22,0.3)] cursor-pointer
  ...
  <ScrollReveal>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
      ...
      {/* Paso 1 */}
      <div className="p-10 rounded-[2rem] bg-gradient-to-b from-neutral-900/80 to-neutral-950 border border-neutral-800/80 text-center relative overflow-hidden group hover:-translate-y-3 hover:border-orange-500/30 hover:shadow-[0_15px_40px_-15px_rgba(249,115,22,0.2)] transition-all duration-500 cursor-default">
        {/* Número gigante - CORREGIDO EL COLOR PARA MÁS CONTRASTE */}
        <div className="absolute -top-6 -right-6 text-[180px] leading-none font-black text-neutral-700/30 group-hover:text-neutral-500/50 group-hover:-translate-y-4 group-hover:-translate-x-2 group-hover:scale-110 transition-all duration-700 select-none pointer-events-none z-0">
          1
        </div>
        
        {/* Contenedor del ícono con SVG - CORREGIDO */}
        <div className="w-20 h-20 rounded-2xl bg-neutral-900 border border-neutral-800 text-neutral-500 flex items-center justify-center mb-8 mx-auto relative z-10 group-hover:bg-orange-500/10 group-hover:border-orange-500/50 group-hover:text-orange-400 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(249,115,22,0.2)] transition-all duration-500">
          {/* Icono SVG de Búsqueda (Lupa) */}
      ...
      <div className="p-10 rounded-[2rem] bg-gradient-to-b from-neutral-900/80 to-neutral-950 border border-neutral-800/80 text-center relative overflow-hidden group hover:-translate-y-3 hover:border-orange-500/30 hover:shadow-[0_15px_40px_-15px_rgba(249,115,22,0.2)] transition-all duration-500 cursor-default">
        ...
        {/* Contenedor del ícono con SVG - CORREGIDO */}
        <div className="w-20 h-20 rounded-2xl bg-neutral-900 border border-neutral-800 text-neutral-500 flex items-center justify-center mb-8 mx-auto relative z-10 group-hover:bg-orange-500/10 group-hover:border-orange-500/50 group-hover:text-orange-400 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(249,115,22,0.2)] transition-all duration-500 delay-75">
          {/* Icono SVG de Contacto (Burbujas de Chat) */}
          <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-sm text-neutral-400 leading-relaxed relative z-10 group-hover:text-neutral-300 transition-colors">
          Hablá directamente con el trabajador por telefono o mail, pedí un presupuesto a medida y coordiná la visita.
        </p>
      </div>
      ...
      <div className="p-10 rounded-[2rem] bg-gradient-to-b from-neutral-900/80 to-neutral-950 border border-neutral-800/80 text-center relative overflow-hidden group hover:-translate-y-3 hover:border-orange-500/30 hover:shadow-[0_15px_40px_-15px_rgba(249,115,22,0.2)] transition-all duration-500 cursor-default">
        ...
        {/* Contenedor del ícono con SVG - CORREGIDO */}
        <div className="w-20 h-20 rounded-2xl bg-neutral-900 border border-neutral-800 text-neutral-500 flex items-center justify-center mb-8 mx-auto relative z-10 group-hover:bg-orange-500/10 group-hover:border-orange-500/50 group-hover:text-orange-400 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(249,115,22,0.2)] transition-all duration-500 delay-150">
          {/* Icono SVG de Calificación (Estrella) */}
          <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-sm text-neutral-400 leading-relaxed relative z-10 group-hover:text-neutral-300 transition-colors">
          ...
          {/* SECCIÓN 3: OFICIOS */}
          <section id="oficios" className="min-h-screen flex flex-col items-center justify-center bg-neutral-900/20 border-y border-neutral-900 overflow-hidden w-full relative">
            <ScrollReveal className="w-full">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4">Explorá nuestros <span className="text-orange-500">Oficios</span></h2>
              </div>
              ...
              <div className="w-full relative select-none group">
                ...
                <div className="flex animate-scroll gap-6 py-6 group-hover:[animation-play-state:paused]">
                  {[...filteredProfessions, ...filteredProfessions].map((prof, index) => (
                    <div key={index} className="px-8 py-4 rounded-2xl border text-sm font-bold whitespace-nowrap shadow-xl bg-neutral-950 text-neutral-300 border-neutral-800 flex items-center gap-3">
          ...
          <section id="beneficios" className="min-h-screen flex flex-col items-center justify-center px-4 w-full max-w-5xl mx-auto text-center">
            <ScrollReveal>
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-16">¿Por qué usar <span className="text-orange-500">Laburito?</span></h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                  <span className="text-5xl font-black text-orange-500 block mb-2">Gratis</span>
          ...
          <section className="min-h-screen flex flex-col items-center justify-center px-4 w-full text-center relative">
            ...
            <ScrollReveal>
              <div className="max-w-3xl mx-auto bg-gradient-to-tr from-neutral-900 to-neutral-800 rounded-3xl p-12 border border-neutral-700 shadow-2xl relative overflow-hidden">
                ...
                <button onClick={() => navigate('/register')} className="relative z-10 bg-white text-black font-bold px-8 py-4 rounded-full hover:bg-neutral-200 transition-all cursor-pointer">
